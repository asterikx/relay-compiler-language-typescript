...
describe("formatGeneratedModule", () => {
  ...
  it("replaces cjs require calls by static (top-level) esm imports if module system is esm and esm version is below es2020", () => {
    const formatGeneratedModule = formatterFactory({
  ...
  it("replaces cjs require calls by dynamic esm imports if module system is esm and esm version is above or equal to es2020", () => {
    const formatGeneratedModule = formatterFactory({
    ...
    expect(
      ...
      const node: ReaderFragment = {\\"the\\":{\\"fragment\\":{\\"metadata\\":{\\"refetch\\":{\\"operation\\":\\"await import('./RefetchableFragmentQuery.graphql')\\"}}}}};
      (node as any).hash = 'edcba';
      export default node;
      "
    `);
